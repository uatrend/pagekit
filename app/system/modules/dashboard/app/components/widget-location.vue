        ...
        <div v-show="editing" class="uk-card-header pk-panel-teaser">
            <form class="uk-form-stacked" @submit.prevent>
                ...
                <div class="uk-margin-top">
                    <label class="uk-form-label">{{ 'Google Time Zone API Key' | trans }}</label>

                    <div class="uk-form-controls uk-form-controls-text">
                        <p class="uk-margin-small">
                            <div class="uk-inline uk-width-expand">
                                <div v-if="gApiResult === 'process'" class="uk-form-icon uk-form-icon-flip" uk-spinner ratio="0.6"></div>
                                <div v-else-if="gApiResult === 'success'" class="uk-form-icon uk-form-icon-flip uk-text-success" uk-icon="check"></div>
                                <a v-else class="uk-form-icon uk-form-icon-flip" @click="gApiTest()" uk-icon="refresh"></a>
                                <input v-model="widget.GOOGLE_API_KEY" class="uk-input">
                            </div>
